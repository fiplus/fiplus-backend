...
frisby.create('Tag an event with existing interest')
    .put("http://localhost:8529/_db/fiplus/dev/extensions/event/1/interest/soccer")
    .expectStatus(200)
    .toss();

frisby.create('Tag an event with a non-existing interest')
    .put("http://localhost:8529/_db/fiplus/dev/extensions/event/1/interest/newinterest")
    .expectStatus(200)
    .toss();

frisby.create('Tag an non-existing activity')
    .put("http://localhost:8529/_db/fiplus/dev/extensions/event/0/interest/soccer")
    .expectStatus(404)
    .toss();
